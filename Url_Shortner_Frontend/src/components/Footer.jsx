...
const Footer = () => {
  ...
  const date=new Date();
  // console.log(date.getFullYear(),"From Footer");
  return (
    <footer className="bg-custom-gradient text-white py-8 z-40 relative">
      <div className="container mx-auto px-6 lg:px-14 flex flex-col lg:flex-row lg:justify-between items-center gap-4">
        ...
        <p className="mt-4 lg:mt-0">
          &copy; {date.getFullYear()} Linklytics. All rights reserved.
        </p>
        ...
        <div className="flex space-x-6 mt-4 lg:mt-0">
          ...
          <a href="https://www.linkedin.com/in/pranav-bagal-12243322a/" target="_blank" className="hover:text-gray-200">
            <FaLinkedin size={24} />
          </a>
        </div>
      </div>
